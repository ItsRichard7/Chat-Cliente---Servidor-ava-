...
public class Client1_Window extends javax.swing.JFrame implements Observer {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Client client = new Client(6000, mensaje);
        ...
        client = new Client(6000, respuesta);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Client1_Window.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Client1_Window().setVisible(true);
            }
        });
    }
